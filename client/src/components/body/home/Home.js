            ...
            >
              <div class="carousel-inner">
                ...
                <div class="carousel-item">
                  ...
                  <div class="carousel-caption ">
                    <h5 class="animated fadeInDown">
                    Our trusted symptom checker is written and reviewed by physicians. 
                    </h5>
                    <p class="animated fadeInUp d-none d-md-block">
                    Find a possible diagnosis by choosing a symptom and answering a few simple questions.
                    </p>
                    <div className="slider-btn">
                      <a href="/articles">Symptom Checker</a>
                    </div>
                  </div>
                </div>
              </div>
