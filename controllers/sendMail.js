...
const sendEmail = (email, url, txt) => {
  ...
  const mailOptions = {
    ...
    to: email,
    subject: "HealthyMe: Account Activation Link",
    html: `
    ...
    <h2 style="font-family: comic sans ms,sans-serif; font-size: 35px;color:crimson;"><strong>Welcome to HealthyMe+</strong></h2>

    <hr>

    <p style="font-size: 20px;"> Hi ,</p>
    
    <p style="font-size: 20px;">You're almost set to start using HealthyMe.
